...
//	private GarageService garageService;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Automobile autoDaEliminare = automobileService.caricaSingoloAutomobile(automobileId);
		
		automobileService.rimuovi(autoDaEliminare);
		
		RequestDispatcher rd = request.getRequestDispatcher("PrepareSearchAutomobileServlet");
