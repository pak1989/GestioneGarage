    ...
    <div class="page-header">
	  <h3>Pagina di Modifica</h3>
		...
		<c:forEach var="messaggioItem" items="${messaggiErrore}">
	  	...
	  	<form id="modificaForm" class="form-horizontal" action="ExecuteModificaAutomobileServlet" method="post">
	  	
	  		<div class="form-group">
      			<label class="control-label col-sm-2" for="idInputId"></label>
	    		<div class="col-sm-4">
					<input class="form-control"  type="hidden" id="idInputId" name="automobileId" value="${automobileSingola.id}${automobileDTO.id}">
			 	</div>automobileDTO
  			</div>
	      	...
	      	<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="marcaInput"
						name="marcaInput" value="${automobileSingola.marca}${automobileDTO.marca}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="modelloInput"
						name="modelloInput" value="${automobileSingola.modello}${automobileDTO.modello}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="number" id="cilindrataInput"
						name="cilindrataInput" value="${automobileSingola.cilindrata}${automobileDTO.cilindrata}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="targaInput"
						name="targaInput" value="${automobileSingola.targa}${automobileDTO.targa}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="garageInputId"
						name="garageInput" value="${automobileSingola.garage.nome}${automobileDTO.garage.nome}">
					<input type="hidden" name="garageId" id="garageId" value="${automobileSingola.garage.id}${automobileDTO.garage.id}">
				</div>
			</div>	
